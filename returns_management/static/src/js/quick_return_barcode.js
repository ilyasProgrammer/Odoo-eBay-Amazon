odoo.define('returns_management.QuickReturns', function (require) {
"use strict";
...
var QuickReturnsBarcodeHandler = FormViewBarcodeHandler.extend({
    ...
    start: function() {
        ...
        this.m2x_field = 'return_line_ids';
    ...
    pre_onchange_hook: function(barcode) {
        ...
        var field = this.form_view.fields.return_line_ids;
...
core.form_widget_registry.add('quick_returns_barcode_handler', QuickReturnsBarcodeHandler);
