...
class SaleMarginMAPMPBL(models.TransientModel):
    _name = 'sale.margin.mapm.pbl.wizard'
    ...
    def default_get(self, fields):
        result = super(SaleMarginMAPMPBL, self).default_get(fields)
    ...
    def button_download_report(self):
        return {
            ...
            'url': '/reports/sales_margin_mapm_pbl?id=%s' % self.id,
            'target': 'new',
        }
