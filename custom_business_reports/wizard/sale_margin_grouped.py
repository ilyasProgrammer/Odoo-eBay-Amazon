...
class SaleMarginGrouped(models.TransientModel):
    _name = 'sale.margin.grouped.wizard'
    ...
    def default_get(self, fields):
        result = super(SaleMarginGrouped, self).default_get(fields)
    ...
    def button_download_report(self):
        return {
            ...
            'url': '/reports/sales_margin_grouped?id=%s' % self.id,
            'target': 'new',
        }
