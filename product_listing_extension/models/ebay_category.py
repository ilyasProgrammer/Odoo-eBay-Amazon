...
class EbayCategory(models.Model):
    ...
    parent_id = fields.Many2one('product.ebay.category', 'Parent Category', index=True, ondelete='cascade')
    child_id = fields.One2many('product.ebay.category', 'parent_id', 'Child Categories')
    parent_left = fields.Integer('Left Parent', index=1)
    parent_right = fields.Integer('Right Parent', index=1)
    ebay_category_id = fields.Integer('Category ID')
    is_leaf_category = fields.Boolean('Leaf Category', default=False)
